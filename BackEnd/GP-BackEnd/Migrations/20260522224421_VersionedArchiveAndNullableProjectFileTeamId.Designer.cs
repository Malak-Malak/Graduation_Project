...
namespace GP_BackEnd.Migrations
{
    ...
    [Migration("20260522224421_VersionedArchiveAndNullableProjectFileTeamId")]
    partial class VersionedArchiveAndNullableProjectFileTeamId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GP_BackEnd.Models.ArchivedFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GP_BackEnd.Models.DiscussionSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GP_BackEnd.Models.Team", b =>
                {
                    ...
                    b.Property<DateTime?>("ArchivedAtV0")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ArchivedAtV1")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("IsArchivedV0")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsArchivedV1")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSubmittedV0")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSubmittedV1")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("GP_BackEnd.Models.TeamDiscussionSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DiscussionSlotId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DiscussionSlotId");

                    b.HasIndex("TeamId");

                    b.ToTable("TeamDiscussionSlots");
                });
            ...
            modelBuilder.Entity("GP_BackEnd.Models.DiscussionSlot", b =>
                {
                    b.HasOne("GP_BackEnd.Models.User", "HeadOfDepartment")
                        .WithMany()
            ...
            modelBuilder.Entity("GP_BackEnd.Models.TeamDiscussionSlot", b =>
                {
                    b.HasOne("GP_BackEnd.Models.DiscussionSlot", "DiscussionSlot")
                        .WithMany("TeamSlots")
                        .HasForeignKey("DiscussionSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
